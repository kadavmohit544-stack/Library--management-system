/* ==========================================
   ...
   ELECTRONICS ENGINEERING PAGE JAVASCRIPT
========================================== */
...
document.querySelectorAll(".read-btn").forEach(button => {
    ...
    button.addEventListener("click", () => {
        ...
        alert(
            "📖 " + title +
            "\n\nThis Electronics Engineering book is available in Smart Digital Library."
        );
...
console.log("💻 Electronics Engineering Books Page Loaded Successfully");