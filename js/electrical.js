/* ==========================================
   ...
   ELECTRICAL ENGINEERING PAGE JAVASCRIPT
========================================== */
...
document.querySelectorAll(".read-btn").forEach(button => {
    ...
    button.addEventListener("click", () => {
        ...
        alert(
            "📖 " + title +
            "\n\nThis Electrical Engineering book is available in Smart Digital Library."
        );
...
console.log("⚡ Electrical Engineering Books Page Loaded Successfully");